...
let output_1 = fs.readFileSync('data.txt', 'utf8').trim() // To remove the unnecessary spaces/lines
...
let output_2 = fs.readFileSync('data.txt', 'utf8').trim() // To remove the unnecessary spaces/lines
.split('\n') // Splitting each line to array
.map(line => line.split(' ')) // Making the input into a convinent array of objects
